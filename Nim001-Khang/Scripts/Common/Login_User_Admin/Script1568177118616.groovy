...
WebUI.setText(findTestObject('Login/textbox_Username') , GlobalVariable.UserAdmin
	)
WebUI.setText(findTestObject('Login/textbox_Password') , GlobalVariable.UserAdmin
	)
