...
WebUI.setText(findTestObject('Form_NhapTay/newtankaValueRow1'), '5000')

WebUI.click(findTestObject('Form_NhapTay/btnAddGridInsert'))

WebUI.click(findTestObject('Form_NhapTay/clickShohincdRow2'))

WebUI.click(findTestObject('Form_NhapTay/findShohinCDRow2'))

WebUI.click(findTestObject('Form_NhapTay/choose_shohin_0007'))

WebUI.click(findTestObject('Form_NhapTay/newtanka_valueRow2'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Form_NhapTay/newtankaValueRow2'), '5000')

WebUI.click(findTestObject('Object Repository/Form_NhapTay/btnApply'))

WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet17\\Sheet17_No8.png')
