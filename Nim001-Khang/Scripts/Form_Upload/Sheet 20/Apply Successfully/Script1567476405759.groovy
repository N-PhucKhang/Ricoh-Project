...
WebUI.click(findTestObject('Object Repository/Form_Upload/button_AddFile1'))  // Click button add file 1

WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), "C:\\users\\Dell\\Downloads\\nim001\\no_error.csv")  // Up file no_error.csv

WebUI.waitForPageLoad(2)

WebUI.click(findTestObject('Object Repository/Form_Upload/button_UpFile_Popup'))  // Click button add file
