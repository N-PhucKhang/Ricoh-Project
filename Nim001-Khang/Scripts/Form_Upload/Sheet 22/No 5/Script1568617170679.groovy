...
def recordset1 = CustomKeywords.'com.database.connectSql.executeQuery'((('update IMFR_UT_SF_NIM001_APL002_TB1 set IMFR_UD_TB1_SHOHIN_CODE = \'A00003\' , IMFR_UD_TB1_JYORYO_SYS_CODE = \'11111111117\' , IMFR_UD_TB1_UPDATE_KUBUN =  \'1\'  where IMFR_SD_INSERT_ID =' + 
    '\'') + GlobalVariable.insert_ID) + '\'')
