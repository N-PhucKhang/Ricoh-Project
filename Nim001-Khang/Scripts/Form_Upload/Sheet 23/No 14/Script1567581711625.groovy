...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No14 + 
    ...
    WebUI.maximizeWindow()
	WebUI.delay(1)
    WebUI.verifyTextPresent('商品コードは６桁で入力してください', false, FailureHandling.CONTINUE_ON_FAILURE)
