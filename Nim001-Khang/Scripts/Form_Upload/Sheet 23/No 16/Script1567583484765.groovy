...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No16 + 
    ...
    WebUI.maximizeWindow()
    WebUI.verifyTextPresent('MoM顧客別単価マスタに登録済みコードが設定されています', false, FailureHandling.CONTINUE_ON_FAILURE)
