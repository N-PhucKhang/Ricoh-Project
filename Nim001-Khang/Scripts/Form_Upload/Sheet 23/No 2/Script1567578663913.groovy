...
WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), RunConfiguration.getProjectDir() + GlobalVariable.No2)
WebUI.delay(1)
...
//WebUI.verifyTextPresent('更新区分が正しく設定されていません。1:登録、2:更新、3:削除の区分値を設定してください ', false , FailureHandling.STOP_ON_FAILURE )
...
WebUI.delay(2)
WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet23\\No2.png' // Take screen shot
    )
WebUI.closeBrowser()
