...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No23 + 
    ...
    WebUI.maximizeWindow()
    WebUI.verifyTextPresent('原価振替商品コード６桁で入力してください。', false, FailureHandling.CONTINUE_ON_FAILURE)
