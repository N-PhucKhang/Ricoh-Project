...
for (int i = 1; i <= totalFile; i++) {
	...
	//WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet23\\No5-3.png') // Take screen shot
	WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet23\\No8-' + i + '.png') // Take screen shot
	WebUI.delay(2)
	WebUI.verifyTextPresent("上流システムコードが取引停止となっています", false)
