...
WebUI.click(findTestObject('Form_NhapTay/iconDate'))

WebUI.click(findTestObject('Form_NhapTay/chooseHoliday'))

WebUI.click(findTestObject('Form_NhapTay/btnApply'))

WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet17\\Sheet17_No5.png')
