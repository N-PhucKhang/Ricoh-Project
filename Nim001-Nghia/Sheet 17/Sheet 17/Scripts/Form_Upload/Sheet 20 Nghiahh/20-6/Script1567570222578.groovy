...
WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), 'D:\\nim001\\nim001\\error.csv' // Up file khang38.csv
    )
...
WebUI.click(findTestObject('Form_Upload/button_ReadFile'))

WebUI.click(findTestObject('Object Repository/Form_Upload/button_Apply'))

WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet20\\Sheet20_No4.png' // Take screen shot
    )
