...
//Mục [単価適用日](system date) là thứ 7
...
WebUI.click(findTestObject('Form_Upload/Calendar/Saturday'))
...
WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet20\\systemday_is_Saturday.png')
