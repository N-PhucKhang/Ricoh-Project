...
int countRows = WebUI.executeJavaScript("return \$('#gt6').jqGrid('getGridParam', 'records');", null)

if(countRows != 0) {

	WebUI.click(findTestObject('QLNV_Form/Tab4/checkbox_CheckAll'))
...
err_msg = WebUI.getText(findTestObject('QLNV_Form/Tab4/error_msg'))

WebUI.verifyMatch(err_msg, '対象がありません。', true, FailureHandling.STOP_ON_FAILURE)
