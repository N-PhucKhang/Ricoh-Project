...
WebUI.setText(findTestObject('Object Repository/Login/textbox_Username'), 'dev04')

WebUI.setText(findTestObject('Object Repository/Login/textbox_Password'), 'dev04')
