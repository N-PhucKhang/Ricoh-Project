...
for (int i = 1; i <= totalFile; i++) {
	...
	WebUI.takeScreenshot('D:\\KatalonScreenShot\\Sheet23\\No12-' + i + '.png') // Take screen shot
	WebUI.delay(2)
	//WebUI.verifyTextPresent("適用開始日が翌日以降で設定してください", false)
	
	MsgErr = WebUI.getText(findTestObject('Object Repository/Form_Upload/check_Text1'))
	WebUI.verifyEqual(MsgErr, "適用開始日が翌日以降で設定してください")
