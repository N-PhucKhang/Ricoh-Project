...
//WebUI.getText(findTestObject('QLNV_Form/Tab6/input_paper_no'))
...
def DBCombinationKey = CustomKeywords.'com.database.connectSql.executeQuery'("SELECT imfr_ud_journal_date , imfr_ud_voucher_no , imfr_ud_product_cd , imfr_ud_product_name , imfr_ud_uncollected , imfr_ud_overpayment , imfr_ud_inquiry_number , imfr_ud_section_nm , imfr_ud_application_key , imfr_ud_counter_dept_cd , imfr_ud_detail_description FROM imfr_ut_sf_nim008_apl001 WHERE imfr_sd_insert_id IN (" + paper_no + ")")
...
WebUI.verifyEqual(Integer.parseInt(count), DBCombinationKey.size())
