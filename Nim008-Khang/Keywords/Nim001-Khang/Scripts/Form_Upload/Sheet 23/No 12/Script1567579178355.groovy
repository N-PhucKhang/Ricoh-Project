...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No12 + 
    ...
    WebUI.maximizeWindow()
    WebUI.verifyTextPresent("適用開始日が翌日以降で設定してください", false, FailureHandling.CONTINUE_ON_FAILURE)
