...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No20 + 
    ...
    WebUI.maximizeWindow()
	WebUI.delay(1)
    WebUI.verifyTextPresent('統一仕切未満です。', false, FailureHandling.CONTINUE_ON_FAILURE)
