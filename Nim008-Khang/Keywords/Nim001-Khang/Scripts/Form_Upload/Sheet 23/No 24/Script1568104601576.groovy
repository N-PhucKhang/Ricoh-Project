...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No24 + 
    ...
    WebUI.maximizeWindow()
	WebUI.delay(1)
    WebUI.verifyTextPresent('原価振替商品コードが単価と矛盾しています', false, FailureHandling.CONTINUE_ON_FAILURE)
