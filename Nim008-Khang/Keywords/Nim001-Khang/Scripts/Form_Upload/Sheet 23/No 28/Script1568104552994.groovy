...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No28 + 
    ...
    WebUI.verifyEqual(MsgErr1, '原価振替商品コードと単価が矛盾しています', FailureHandling.CONTINUE_ON_FAILURE)
