...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No30 + 
    ...
    WebUI.verifyEqual(MsgErr1, '単価に不正な値が設定されています', FailureHandling.CONTINUE_ON_FAILURE)
