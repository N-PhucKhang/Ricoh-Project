...
for (int i = 1; i <= totalFile; i++) {
    ...
    WebUI.delay(2)
    WebUI.setText(findTestObject('Form_Upload/button_AddFile_Popup'), Folder_Url + GlobalVariable.No8 + 
    ...
    WebUI.maximizeWindow()
    WebUI.verifyTextPresent('上流システムコードが取引停止となっています', false, FailureHandling.CONTINUE_ON_FAILURE)
