...
def static "upload.uploadfile.uploadFile"(
    	TestObject to	
     , 	String filePath	) {
    (new upload.uploadfile()).uploadFile(
        	to
         , 	filePath)
}

def static "helpers.Tab2Helpers.convert"(
    	String string	) {
    (new helpers.Tab2Helpers()).convert(
        	string)
}

def static "helpers.Tab2Helpers.convertStringToBigDecimal"(
    	String string	) {
    (new helpers.Tab2Helpers()).convertStringToBigDecimal(
        	string)
}

def static "helpers.Tab2Helpers.countItems"(
    	java.util.LinkedList<String[]> array	) {
    (new helpers.Tab2Helpers()).countItems(
        	array)
}

def static "helpers.Tab2Helpers.getColumnTotalValue"(
    	java.util.LinkedList<String[]> array	
     , 	Integer columnNo	) {
    (new helpers.Tab2Helpers()).getColumnTotalValue(
        	array
         , 	columnNo)
}

def static "helpers.Tab2Helpers.getGridTableHeaderName"(
    	String gridTable	) {
    (new helpers.Tab2Helpers()).getGridTableHeaderName(
        	gridTable)
}

def static "helpers.Tab2Helpers.getGridTableData"(
    	String gridTable	) {
    (new helpers.Tab2Helpers()).getGridTableData(
        	gridTable)
}

def static "helpers.Tab2Helpers.surveySumariesData"(
    ...
    (new helpers.Tab2Helpers()).surveySumariesData(
