...
println((((((('Summary sales com detail list from DB: ' + CustomKeywords.'com.helpers.Tab2Helpers.countItems'(sales_com_detail_list)) + 
    ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(sales_com_detail_list, 7)) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(
        sales_com_detail_list, 8)) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(sales_com_detail_list, 
        9))

def array_summaries_detail_from_db = [CustomKeywords.'com.helpers.Tab2Helpers.countItems'(sales_com_detail_list), CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(
        sales_com_detail_list, 7), CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(sales_com_detail_list, 8)
...
println((((((('Summaries values from DB: ' + sales_com_summary_list.get(0).get(0)) + ' ') + sales_com_summary_list.get(0).get(
        2)) + ' ') + sales_com_summary_list.get(0).get(3)) + ' ') + sales_com_summary_list.get(0).get(4))

def array_summaries_from_db = [CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(sales_com_summary_list.get(
            0).get(0).toString()), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(sales_com_summary_list.get(
            0).get(2).toString()), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(sales_com_summary_list.get(
            0).get(3).toString()), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(sales_com_summary_list.get(
            0).get(4).toString())]
...
println((((((('Summaries grid table detail: ' + CustomKeywords.'com.helpers.Tab2Helpers.countItems'(gt_detail_datas)) + 
    ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(gt_detail_datas, 0)) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(
        gt_detail_datas, 6)) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(gt_detail_datas, 7))

def array_summaries_detail_from_grid_table = [CustomKeywords.'com.helpers.Tab2Helpers.countItems'(gt_detail_datas), CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(
        gt_detail_datas, 0), CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(gt_detail_datas, 6), CustomKeywords.'com.helpers.Tab2Helpers.getColumnTotalValue'(
        gt_detail_datas, 7)]
...
println((((((((('Summaries grid table summaries: ' + ((gt_summaries_datas[0])[5])) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(
        (gt_summaries_datas[0])[1])) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[
        0])[0])) + ' ') + CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[0])[2])) + 
    ' ') + CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[0])[3]))

def array_summaries_from_grid_table = [CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[
        0])[1]), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[0])[0]), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'(
        (gt_summaries_datas[0])[2]), CustomKeywords.'com.helpers.Tab2Helpers.convertStringToBigDecimal'((gt_summaries_datas[
        0])[3])]
...
CustomKeywords.'com.helpers.Tab2Helpers.surveySumariesData'(array_summaries_detail_from_db, array_summaries_from_db, array_summaries_detail_from_grid_table, 
