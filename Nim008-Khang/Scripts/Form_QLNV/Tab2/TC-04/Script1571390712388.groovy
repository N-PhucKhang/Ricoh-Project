...
//def UpdateDBCombinationKey = CustomKeywords.'com.database.connectSql.executeQuery'("UPDATE IMFR_UT_SF_NIM008_APL001 SET IMFR_UD_CLEARED_FLAG = '0' WHERE IMFR_UD_SALES_COM = '11'")
