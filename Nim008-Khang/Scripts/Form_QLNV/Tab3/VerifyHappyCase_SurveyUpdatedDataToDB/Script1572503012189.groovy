...
String sqlCombinationKey = "SELECT IMFR_UD_APP_COMBINATION_KEY FROM IMFR_UT_SF_NIM008_APL001 WHERE IMFR_UD_APP_COMBINATION_KEY IN " + ParamCombinationKey
def DBCombinationKey = CustomKeywords.'com.database.connectSql.executeQuery'(sqlCombinationKey)
println(DBCombinationKey)

String sqlClearedFlag = "SELECT IMFR_UD_CLEARED_FLAG FROM IMFR_UT_SF_NIM008_APL001 WHERE IMFR_UD_APP_COMBINATION_KEY IN " + ParamCombinationKey
