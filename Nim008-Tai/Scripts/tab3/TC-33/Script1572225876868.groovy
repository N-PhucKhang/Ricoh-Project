...
WebUI.click(findTestObject('Tab3/check_box_tab4'))

hdd_insertId = WebUI.getAttribute(findTestObject('Tab3/hdd_insert_id_tab4'), 'title')

WebUI.click(findTestObject('Tab3/clear_tab4'))
